...
export default function LoginPage() {
  ...
  // FIX: Provide a default empty object {} if state.auth is undefined during prerendering
  // This ensures that 'loading' and 'authErrorObject' will get default 'undefined'
  // instead of causing a destructuring error.
